...
;; apply fn to every element of a given list

(check-expect (map2 sqr empty) empty)
(check-expect (map2 sqr (list 3 2)) (list 9 4))
...
;; filter the elements out of the list for which applying q? produces false
